...
if (isset($_POST['title']) && isset($_POST['body']) && isset($_FILES['image'])) {
    if (!empty($_POST['title']) && !empty($_POST['body'])) {
        ...
        $articleInsertQuery = 'INSERT INTO Article (title, body, date_of_publ, User_id, Category_id, image) INNER JOIN Category ON Category.id = Article.Category_id VALUES (?, ?, NOW(), ?, ?,?) INNER JOIN Category ON Category.id = Article.Category_id';
